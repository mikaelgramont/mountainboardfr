<?php
class Lib_Validate_Dpt extends Lib_Validate_Data
{
    const DOES_NOT_EXIST = 'dptDoesNotExist';
    const EXISTS = 'dptExists';

    /**
     * @var array
     */
    protected $_messageTemplates = array(
        self::DOES_NOT_EXIST => "dptDoesNotExist",
        self::EXISTS => "dptExists"
    );
